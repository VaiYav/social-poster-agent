...
| 0.5.5 | 2026-08-06 | **F4 Adaptive Replies (partial):** F4.A LLM safety classifier for injection/spam/toxic comments, F4.B daily per-network Redis rate limit for auto/manual replies, F4.D rule-based tone analyzer with tone-aware reply prompt. Added 19 new unit tests (1528 pass). §16 F4 marked partial. |
