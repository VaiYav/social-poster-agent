...
export class ContentSourceController {
  ...
  @ApiQuery({ name: 'limit', required: false, type: Number, description: 'Max briefs (default 10)' })
  ...
  @ApiQuery({ name: 'limit', required: false, type: Number, description: 'Max articles (default 10)' })
