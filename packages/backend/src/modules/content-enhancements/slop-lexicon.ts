...
export const SLOP_LEXICON: Record<string, SlopLexiconEntry> = {
  en: {
    ...
    phrases: [
      ...
      'often overlooked', 'frequently overlooked',
  ...
  ru: {
    ...
    phrases: [
      ...
      'знаете ли вы', 'подводя итог', 'в заключение',
      ...
      'часто упускают', 'часто упускают из виду',
  ...
  uk: {
    ...
    phrases: [
      ...
      'відкрийте для себе', 'зануртеся у світ',
      ...
      'дружнє нагадування', 'нагадування, що',
  ...
  es: {
    ...
    phrases: [
      ...
      'a menudo pasado por alto', 'frecuentemente pasado por alto',
      'recordatorio amistoso', 'recordatorio de que', 'no olvides',
