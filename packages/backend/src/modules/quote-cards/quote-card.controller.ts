 ...
 */
import { Controller, Post, Get, Body, Query, Res, HttpStatus, UseGuards, NotFoundException, BadRequestException } from '@nestjs/common';
...
export class QuoteCardController {
  ...
  async generate(
    @Body() body: GenerateQuoteCardBody,
