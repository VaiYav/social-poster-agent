...
import { clearHookCache, getHookCacheStats } from '../../../src/modules/generation/generation.graph';
...
describe('Hook Cache', () => {
  ...
  it('HC-002: second run with same topic skips LLM call (cache hit)', async () => {
    ...
    const callsAfterSecondRun = (mockLlm.generateChat as ReturnType<typeof vi.fn>).mock.calls.length;
