...
import {
  analyzeHumanization,
  buildHumanizeInstruction,
} from "../../../src/modules/content-enhancements/humanizer-gate.js";
...
describe("Humanizer Gate", () => {
  ...
  it("HG-003: uniform sentence lengths are flagged (low burstiness)", () => {
    const text =
      "The workflow rules your inbox tonight. The brand rules your public image now. Productivity rules your anger and drive.";
    const report = analyzeHumanization(text, "en");
  ...
  it("HG-005: slop words trigger the gate", () => {
    ...
    const es = buildHumanizeInstruction(
      "En el mundo actual, la productividad transforma todo.",
      "es",
    );
