...
import { extractTopic, computeVariantStats, pickWinner } from '../../../src/modules/content-enhancements/ab-test.utils';
...
describe('ab-test.utils', () => {
  ...
  describe('computeVariantStats', () => {
    it('computes averages and engagement correctly', () => {
      const rows = [
        { likes: 10, comments: 2, shares: 1, impressions: 100, judgeScores: { anti_ai_tone: 0.8, hook_strength: 0.7 }, content: '', label: 'a', post: { sourceRef: {} } },
        { likes: 20, comments: 4, shares: 2, impressions: 200, judgeScores: { anti_ai_tone: 0.6, hook_strength: 0.9 }, content: '', label: 'a', post: { sourceRef: {} } },
      ];
    ...
    it('returns null for optional averages when all values are missing', () => {
      const rows = [
        { likes: 0, comments: 0, shares: 0, impressions: null, judgeScores: null, content: '', label: 'b', post: { sourceRef: {} } },
      ];
  ...
  describe('pickWinner', () => {
    it('returns the variant with the highest engagement', () => {
      const variants = [
        { label: 'a', sampleSize: 5, avgEngagement: 12, avgLikes: 0, avgComments: 0, avgShares: 0, avgImpressions: null, avgAntiAiTone: null, avgHookStrength: null },
        { label: 'b', sampleSize: 5, avgEngagement: 20, avgLikes: 0, avgComments: 0, avgShares: 0, avgImpressions: null, avgAntiAiTone: null, avgHookStrength: null },
      ];
    ...
    it('returns null when no variants meet the minimum sample size', () => {
      const variants = [
        { label: 'a', sampleSize: 2, avgEngagement: 100, avgLikes: 0, avgComments: 0, avgShares: 0, avgImpressions: null, avgAntiAiTone: null, avgHookStrength: null },
        { label: 'b', sampleSize: 2, avgEngagement: 1, avgLikes: 0, avgComments: 0, avgShares: 0, avgImpressions: null, avgAntiAiTone: null, avgHookStrength: null },
      ];
    ...
    it('returns null when there is a tie', () => {
      const variants = [
        { label: 'a', sampleSize: 5, avgEngagement: 10, avgLikes: 0, avgComments: 0, avgShares: 0, avgImpressions: null, avgAntiAiTone: null, avgHookStrength: null },
        { label: 'b', sampleSize: 5, avgEngagement: 10, avgLikes: 0, avgComments: 0, avgShares: 0, avgImpressions: null, avgAntiAiTone: null, avgHookStrength: null },
      ];
