...
describe('DwellTimeCalculator', () => {
  ...
  it('DT-002: scales with word count', () => {
    ...
    const long = calculateDwellTimeMs('one two three four five six seven eight nine ten eleven twelve thirteen fourteen fifteen', false);
    ...
    for (let i = 0; i < 20; i++) {
      ...
      longTotal += calculateDwellTimeMs('one two three four five six seven eight nine ten eleven twelve thirteen fourteen fifteen', false);
    }
