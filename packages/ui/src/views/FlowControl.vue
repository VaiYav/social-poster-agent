...
<template>
  <div class="space-y-6">
    ...
    <Card class="p-6" :class="crisisActive ? 'border-red-500 bg-red-500/10' : ''">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="rounded-lg p-3" :class="crisisActive ? 'bg-red-500/20' : 'bg-surface-elevated'">
            <AlertTriangle class="h-8 w-8" :class="crisisActive ? 'text-red-500' : 'text-text-secondary'" />
          </div>
          <div>
        ...
        <Button
          :variant="crisisActive ? 'primary' : 'destructive'"
          @click="toggleCrisis"
        >
    ...
    <!-- Loading/Error -->
    <div v-if="flowControl.error" class="text-sm text-red-500">
