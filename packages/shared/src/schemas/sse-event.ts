...
export const SseFlowControlEventSchema = z.object({
  ...
  flow: z
    .enum(["generation", "posting", "engagement", "replies", "llm_triage", "auto_approve"])
    .optional(),
  reason: z.string().nullable().optional(),
  timestamp: z.string().optional(),
});
...
export type SseBrowsingSessionCompletedEvent = z.infer<
  typeof SseBrowsingSessionCompletedEventSchema
>;
