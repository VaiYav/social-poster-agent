...
|---------|--------|--------|----------------|-----------------|
| [A/B Testing Infrastructure](./ab-testing-infrastructure.md) | Proposal / partial | M–L | Closes the feedback loop between `abVariants`, `judgeScores`, and real-world approve/reject/engagement. | `content-enhancements.md`, `infrastructure-llm.md`, `analytics.md` |
| [Content Adapters Beyond CAP](./content-adapters.md) | Proposal | M | Decouples content discovery from the sibling `content-agent-platform` repo; enables RSS, APIs, Google Trends, etc. | `content-source.md`, `infrastructure-prisma.md`, `recycling.md` |
| [Operator Dashboard](./operator-dashboard.md) | Proposal | M–L | Single pane of glass for posts, queues, sessions, LLM provider health, alerts, and quality. | `analytics.md`, `queue.md`, `sessions.md`, `health-monitor.md`, `events.md` |
...
| [Prompt Versioning & A/B in Langfuse](./prompt-versioning-langfuse.md) | Proposal | S–M | Wires `PROMPT_VERSION` into Langfuse label fetches and enables prompt-level A/B testing. | `infrastructure-llm.md`, `ab-testing-infrastructure.md` |
